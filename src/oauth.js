...
module.exports = {
    createInstance: (appId, loginURL, oauthCallbackURL, mode) => {
        return mode =='sdk' ? new OAuthCordova(appId, loginURL, oauthCallbackURL) : new OAuthWeb(appId, loginURL, oauthCallbackURL);
    }
}
